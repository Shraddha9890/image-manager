...
const Modal = () => {
    ...
    if (!appContext) {
        // Optionally render nothing or an error if context is missing
        return null;
    }

    const { setselectedImageId, selectedImageTitle,
        setselectedImageTitle, handleTitleUpdate, isLoading, handleImageDelete } = appContext;
