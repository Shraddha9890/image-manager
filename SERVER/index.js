...
app.use(morgan("dev"));
app.use(cors({
  origin: ["https://image-manager-eight.vercel.app", "http://localhost:5173"],
...
const options = {
    definition: {
        ...
        servers: [
            {
                url: "https://server-flame-theta-60.vercel.app/",
...
app.get("/", (req, res) => {
    res.send(`<a href="https://server-flame-theta-60.vercel.app/api-docs/">Swagger Documentation</a>`)
});
